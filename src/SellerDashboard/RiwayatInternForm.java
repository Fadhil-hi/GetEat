...
public class RiwayatInternForm extends javax.swing.JInternalFrame {
    ...
    public RiwayatInternForm(String username) {
        ...
        fillPesananTable(idPointerPenjual);
        selectRow();
    }
    private void fillPesananTable(int id){
        DefaultTableModel model2 = (DefaultTableModel) pesananTable.getModel();
        model2.setRowCount(0);
        String query = "SELECT * FROM pesanan s JOIN pembayaran p ON s.id_Pesanan = p.id_Pesanan WHERE s.id_Penjual = ? AND status_Psnn = ?";

            try (Connection connection = DBNeeds.getConnection()){
            PreparedStatement preparedStatement = connection.prepareStatement(query);
            preparedStatement.setInt(1, id);
            preparedStatement.setString(2, "Selesai diproses");
            ...
            while (resultSet.next()) {
                ...
                model2.addRow(new Object[]{idPesanan, tanggal, statusPsnn, total, idPembeli, idKurir, statusPemb, metodePemb});
            }
    ...
    private void initComponents() {
        ...
        pesananTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Pesanan", "Tanggal", "Status", "Total", "ID Pembeli", "ID Kurir", "Metode Pembayaran", "Status Pembayaran"
            }
        ) {
