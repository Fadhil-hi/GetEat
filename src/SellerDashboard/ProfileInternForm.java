...
public class ProfileInternForm extends javax.swing.JInternalFrame {
    ...
    private void fillField(String username){
        ...
        try (Connection connection = DBNeeds.getConnection()) {
            String selectQuery = "SELECT * FROM penjual WHERE username = ?";
            PreparedStatement preparedStatement = connection.prepareStatement(selectQuery);
            preparedStatement.setString(1, username);
            ResultSet resultSet = preparedStatement.executeQuery();
            
            while (resultSet.next()) {
            idPointer = resultSet.getInt("id_Penjual");
            String nama = resultSet.getString("nama_Toko");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(jalanField, javax.swing.GroupLayout.DEFAULT_SIZE, 309, Short.MAX_VALUE)
